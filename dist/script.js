...
var Download = /*#__PURE__*/function () {
  function Download(triggers) {
    ...
    this.btns = document.querySelectorAll(triggers); // В релаьно проекте будут разыне файлы в каждом модуле ну и путь к файлу соотвествено разный можно использовать switch case
  ...
  _createClass(Download, [{
    ...
    value: function downloadItem(path) {
      ...
      var element = document.createElement('a'); // создали виртуальный элемент ссылки и атрибута 
    ...
    value: function init() {
      ...
      this.btns.forEach(function (item) {
        // если будет пустой массив то он просто не запустится
        item.addEventListener('click', function () {
          //обязательно callbacl ввиде стрелочной
          _this.downloadItem(_this.path); //this.path можно сформировать динамически в заисимтости от кнопки на которую мы нажали
  ...
  _createClass(Form, [{
    ...
    value: function initMask() {
      var setCursorPosition = function setCursorPosition(pos, elem) {
        elem.focus(); // полифил для старых браузеров
    ...
    value: function bindPostData() {
      ...
      _toConsumableArray(this.form).forEach(function (item) {
        item.addEventListener('submit', function (e) {
          e.preventDefault();
          var _this$message = _this.message,
              loading = _this$message.loading,
              success = _this$message.success,
              failure = _this$message.failure;
    ...
    value: function showInfo() {
      this.btns.forEach(function (btn) {
        btn.addEventListener('click', function () {
          ...
          var sibling = btn.parentNode.nextElementSibling; // sibling.nextElementSibling.style.display = 'block';
...
/* harmony import */ var _slider__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./slider */ "./src/js/modules/slider/slider.js");
...
var MainSlider = /*#__PURE__*/function (_Slider) {
  ...
  _createClass(MainSlider, [{
    ...
    value: function showSlides(n) {
      ...
      try {
        ...
        this.hanson.style.opacity = '0'; // 26. Всплывающий со временем блок
  ...
  return MainSlider;
}(_slider__WEBPACK_IMPORTED_MODULE_14__["default"]);
...
var Slider = /*#__PURE__*/_createClass( // 28. Наследование классов. Создаем общий прототип слайдера и главные слайдеры
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  new _modules_playVideo__WEBPACK_IMPORTED_MODULE_2__["default"]('.module__video-item .play', '.overlay').init(); // Loan 13.1
